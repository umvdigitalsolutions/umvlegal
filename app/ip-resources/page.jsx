...
export const metadata = pageMetadata({
  ...
  description:
    "Use UMV Legal IP resources including a trademark class finder, WhatsApp pre-filled inquiry buttons, and downloadable trademark, copyright, and brand protection checklists for Mumbai, Rajasthan, and India.",
  path: "/ip-resources",
  keywords: [
